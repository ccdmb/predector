...
We pin the version of the pipeline to run in all of our example commands with the `-r 1.2.1` parameter.
...
```
nextflow run -profile docker -resume -r 1.2.1 ccdmb/predector \
