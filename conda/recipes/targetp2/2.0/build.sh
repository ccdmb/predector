...
DOWNLOAD_URL=https://services.healthtech.dtu.dk/services/TargetP-2.0/9-Downloads.php#

# What is the expected source tarball named?
TAR_FILE=targetp-2.0.Linux.tar.gz
...
chmod a+x "${TARGET_DIR}/${PEXE}"
chmod a+x "${TARGET_DIR}/placeholder.sh"
