...
ARG SIGNALP3_PREFIX_ARG="/opt/signalp/${SIGNALP3_VERSION}"
...
ARG CHLOROP_VERSION
ARG CHLOROP_PREFIX_ARG="/opt/chlorop/${CHLOROP_VERSION}"
ARG CHLOROP_TAR="sources/chlorop-1.1.Linux.tar.Z"
...
ARG TARGETP_VERSION
ARG TARGETP_PREFIX_ARG="/opt/targetp/${TARGETP_VERSION}"
ARG TARGETP_TAR="sources/targetp-1.1b.Linux.tar.Z"
