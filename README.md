...
conda env create predector/predector/conda env create predector/predector/predector/predector:0.0.1-dev.1
...
| docker build \
  ...
  -t predector/predector:conda env create predector/predector/predector/predector:0.0.1-dev.1 \
  -f - \
  .
```
...
```bash
podman save --format oci-archive --output predector.tar localhost/predector/predector:conda env create predector/predector/predector/predector:0.0.1-dev.1
...
```bash
singularity build predector.sif docker://predector/predector:conda env create predector/predector/predector/predector:0.0.1-dev.1
```
