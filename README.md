...
- [Quick install instructions](https://github.com/ccdmb/predector/wiki/1.2.6#quick-install)
- [Extended install instructions](https://github.com/ccdmb/predector/wiki/1.2.6#extended-dependency-install-guide)
- [Usage](https://github.com/ccdmb/predector/wiki/1.2.6#running-the-pipeline)
- [Description of outputs](https://github.com/ccdmb/predector/wiki/1.2.6#pipeline-output)
- [Common issues](https://github.com/ccdmb/predector/wiki/1.2.6#common-issues)
- [FAQ](https://github.com/ccdmb/predector/wiki/1.2.6#faq)
...
For extended documentation and troubleshooting advice, see the [Wiki install documentation](https://github.com/ccdmb/predector/wiki/1.2.6#quick-install).
...
Please see the [Wiki install documentation](https://github.com/ccdmb/predector/wiki/1.2.6#optional---remove-previous-software-environments-for-old-versions-of-the-pipeline) for more details.
...
```bash
nextflow run -resume -r 1.2.6 ccdmb/predector --proteome "proteomes/*"
```
...
You can find information on available profiles in the [wiki documentation](https://github.com/ccdmb/predector/wiki/1.2.6#profiles-and-configuration).
...
See how to do this in the [extended documentation](https://github.com/ccdmb/predector/wiki/1.2.6#running-different-pipeline-versions) and the [common issues section](https://github.com/ccdmb/predector/wiki/1.2.6#common-issues).
...
You can find a description of all of the results in [the wiki](https://github.com/ccdmb/predector/wiki/1.2.6#pipeline-output).

An example set of results is available in the [`test` directory on github](https://github.com/ccdmb/predector/tree/1.2.6/test/test_set_results).
