...
- [Quick install instructions](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#quick-install)
- [Extended install instructions](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#extended-dependency-install-guide)
- [Usage](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#running-the-pipeline)
- [Description of outputs](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#pipeline-output)
- [Common issues](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#common-issues)
- [FAQ](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#faq)
...
For extended documentation and troubleshooting advice, see the [Wiki install documentation](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#quick-install).
...
Please see the [Wiki install documentation](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#optional---remove-previous-software-environments-for-old-versions-of-the-pipeline) for more details.
...
curl -s "https://raw.githubusercontent.com/ccdmb/predector/1.2.5-alpha/install.sh" \
| bash -s "${ENVIRONMENT}" \
...
This will create the conda environment (named `predector`), or the docker (tagged `predector/predector:1.2.5-alpha`) or singularity (file `./predector.sif`) containers.
...
```bash
nextflow run -profile test -with-conda /home/username/path/to/environment -resume -r 1.2.5-alpha ccdmb/predector
```

#### Using docker

```bash
nextflow run -profile test,docker -resume -r 1.2.5-alpha ccdmb/predector

# if your docker configuration requires sudo use this profile instead
nextflow run -profile test,docker_sudo -resume -r 1.2.5-alpha ccdmb/predector
```

#### Using singularity

```bash
nextflow run -profile test -with-singularity path/to/predector.sif -resume -r 1.2.5-alpha ccdmb/predector

# or if you've build the container using docker and it's in your local docker registry.
nextflow run -profile test,singularity -resume -r 1.2.5-alpha ccdmb/predector
```
...
```bash
nextflow run -resume -r 1.2.5-alpha ccdmb/predector --proteome "proteomes/*"
```
...
You can find information on available profiles in the [wiki documentation](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#profiles-and-configuration).
...
See how to do this in the [extended documentation](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#running-different-pipeline-versions) and the [common issues section](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#common-issues).
...
You can find a description of all of the results in [the wiki](https://github.com/ccdmb/predector/wiki/1.2.5-alpha#pipeline-output).

An example set of results is available in the [`test` directory on github](https://github.com/ccdmb/predector/tree/1.2.5-alpha/test/test_set_results).
