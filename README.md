...
- [Quick install instructions](https://github.com/ccdmb/predector/wiki/1.2.1-beta#quick-install)
- [Extended install instructions](https://github.com/ccdmb/predector/wiki/1.2.1-beta#extended-dependency-install-guide)
- [Usage](https://github.com/ccdmb/predector/wiki/1.2.1-beta#running-the-pipeline)
- [Description of outputs](https://github.com/ccdmb/predector/wiki/1.2.1-beta#pipeline-output)
- [Common issues](https://github.com/ccdmb/predector/wiki/1.2.1-beta#common-issues)
- [FAQ](https://github.com/ccdmb/predector/wiki/1.2.1-beta#faq)
...
For extended documentation and troubleshooting advice, see the [Wiki install documentation](https://github.com/ccdmb/predector/wiki/1.2.1-beta#quick-install).
...
Please see the [Wiki install documentation](https://github.com/ccdmb/predector/wiki/1.2.1-beta#optional---remove-previous-software-environments-for-old-versions-of-the-pipeline) for more details.
...
curl -s "https://raw.githubusercontent.com/ccdmb/predector/1.2.1-beta/install.sh" \
| bash -s "${ENVIRONMENT}" \
...
This will create the conda environment (named `predector`), or the docker (tagged `predector/predector:1.2.1-beta`) or singularity (file `./predector.sif`) containers.
...
```bash
nextflow run -profile test -with-conda /home/username/path/to/environment -resume -r 1.2.1-beta ccdmb/predector
```
...
```bash
nextflow run -profile test -with-singularity path/to/predector.sif -resume -r 1.2.1-beta ccdmb/predector
...
```bash
nextflow run -resume -r 1.2.1-beta ccdmb/predector --proteome "proteomes/*"
```
